...
public class ttasWorkerRunnable implements Runnable{
	 protected Socket socket = null;
	 public static volatile List<Triple> IPlist = new ArrayList<Triple>();//to hold client IPs and requested files
	 //now using a TTAS lock with exponential backoff:
	 public static final TTASLock lock = new TTASLock();
	 
	    public ttasWorkerRunnable(Socket singleSocket) {
